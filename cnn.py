"""
This is an implementation of CharSCNN, and is heavily based on http://www.deeplearning.net/tutorial/lenet.html#lenet
The following code is an implementation exercise of CharSCNN, and might not reflect original ideas.
We achieved about 70% accuracy, on a different dataset than original paper,
and a network with smaller dimensions than original one. The network was trained on a powerful non GPU machine.
